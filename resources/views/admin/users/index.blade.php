...
<head>
  <meta charset="UTF-8">
  <title>KlikBus - Data Pengguna</title>
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .kb-nav-item { display: flex; align-items: center; gap: 12px; padding: 14px 18px; border-radius: 12px; font-size: 16px; color: var(--color-text-secondary); cursor: pointer; margin-bottom: 6px; transition: 0.2s; text-decoration: none; font-weight: 500; }
    ...
    .kb-card-subtitle { color: var(--color-text-secondary); font-size: 14px; margin-bottom: 20px;}
    .kb-table-scroll { flex: 1; overflow-y: auto; }
    .kb-table { width: 100%; border-collapse: collapse; }
    .kb-table thead th { position: sticky; top: 0; background: #fff; text-align: left; padding: 12px 15px; font-size: 14px; color: var(--color-text-tertiary); border-bottom: 2px solid var(--color-border); text-transform: uppercase; font-weight: 600; }
...
<div class="kb-shell">
  <aside class="kb-sidebar">
    ...
    <nav class="kb-nav">
      ...
      <a href="{{ route('admin.users.index') }}" style="text-decoration: none;"><div class="kb-nav-item active"><i class="ti ti-users"></i> Pengguna</div></a>
      <a href="{{ route('admin.settings.index') }}" style="text-decoration: none;"><div class="kb-nav-item"><i class="ti ti-settings"></i> Pengaturan</div></a>
    </nav>
  ...
  <main class="kb-main">
    <div class="kb-topbar">
      <div class="kb-topbar-title">MANAJEMEN PENGGUNA</div>
    </div>

    <div class="kb-content">
      <div class="kb-table-container">
        <div class="kb-card-title">Daftar Akun Terdaftar</div>
        <div class="kb-card-subtitle">Semua pengguna yang memiliki akses ke aplikasi KlikBus.</div>
        ...
        <div class="kb-table-scroll">
          <table class="kb-table">
            ...
            <tbody>
              ...
              @empty
              <tr>
                <td colspan="5" style="text-align: center; padding: 40px;">Belum ada pengguna terdaftar.</td>
              </tr>
              @endforelse
            </tbody>
          </table>
