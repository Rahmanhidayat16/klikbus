        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    {{-- Balikin ke home kalau belum login, ke dashboard kalau udah --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    {{-- Kalau SUDAH Login, tampilin dropdown profil --}}
                ...
                @else
                    {{-- Kalau BELUM Login, tampilin tombol Login/Daftar --}}
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm font-bold text-gray-500 hover:text-blue-600 transition">Masuk</a>
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-blue-600 text-white text-sm font-bold rounded-xl hover:bg-blue-700 transition">Daftar</a>
                    </div>
                @endauth
            </div>
